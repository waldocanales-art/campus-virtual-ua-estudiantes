...
const UALogo=({className=''}:{className?:string})=><svg className={className} viewBox="0 0 448 448" role="img" aria-label="UA"><rect width="448" height="448" rx="28" fill="#ff6500"/><text x="70" y="280" fontFamily="Arial,Helvetica,sans-serif" fontSize="150" fontWeight="700" fill="white">UA</text><path d="M274 145h39c17 0 24 11 29 27l13 43c5 17 17 28 36 33-17 5-29 16-34 33l-14 46h-39l-15-51c-4-14-13-23-27-28 14-5 23-14 27-28z" fill="white"/></svg>
...
export default function Home(){
 ...
 if(!data) return <main className="shell">
  <section className="loginCard">
   <div className="hawksHero">
    <div className="hawksBrand"><UALogo className="uaLogo loginLogo"/><div><h1>HAWKS</h1><span>PLATAFORMA UNIVERSITARIA</span></div></div>
    <div className="hawkMascot" aria-hidden="true">🦅</div>
    <h2>Tecnología que te acompaña <strong>hasta tu próximo logro</strong></h2>
    <div className="hawksBenefits"><span>🎓 <b>Acompaña</b><small>tu recorrido</small></span><span>▥ <b>Anticipa</b><small>bloqueos</small></span><span>⌖ <b>Guía</b><small>tu siguiente paso</small></span><span>☆ <b>Impulsa</b><small>tu logro</small></span></div>
   </div>
 ...
 return <main className="shell">
  <header><div className="headerBrand"><UALogo className="uaLogo headerLogo"/><div><b>UA | HAWKS</b><small>{data.alumno?.nombre||data.grupo?.nombre||data.auth?.grupo||'Estudiante'}</small></div></div><button className="exit" onClick={()=>setData(null)}>Salir</button></header>
